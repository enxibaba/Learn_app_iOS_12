...
class NewsTableViewController: UITableViewController, MenuTransitionManagerDelegate {
    ...
    let mentTransitonManager = MenuTransitionManager()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        menuTableViewController.transitioningDelegate = mentTransitonManager

        mentTransitonManager.delegate = self
    ...
    //Mark: Delegate MenuTransitionManagerDelegate
    func dismiss() {
